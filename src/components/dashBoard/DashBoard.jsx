...
//     : <Box>No Doctor Found</Box>;
// }   , [doctor?.doctor?.doctors]); 


// const appointment = useMemo(() => { 
//   return Array.isArray(appointments?.appointment)
//     ? appointments?.appointment
//     : <Box>No Appointments Found</Box>;
// }   , [appointments?.appointment]); 
...
//               { doctors && doctors?.length > 0 ? doctors : 0
//                //doctor  && doctor.length || 0
//               } Doctors
...
//              { appointment && appointment?.length  > 0 ? appointment : 0} appointments 
