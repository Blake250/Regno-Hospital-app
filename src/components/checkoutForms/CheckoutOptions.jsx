...
useEffect(() => {
  ...
  if (!isLoading && !isError) {
    if (!getThisAppointment || getThisAppointment?._id.toString() !== appointmentId.toString() ) {
      toast.error("Appointment not found");
      navigate("/my-booking");
    }
  }
...
//   // const {appointmentId : bookedId } = useParams()
//   const {appointmentId } = useParams()
...
// //const appointment = getThisAppointment && getThisAppointment?.find( (booked)=> booked._id === bookedId  )
