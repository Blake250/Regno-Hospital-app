  ...
  return (
    <Box sx={{ width: '100%', maxWidth: '100%' }}>
      ...
      >
        ...
        <Box
          sx={{
            display: { xs: 'none', md: 'flex' }, // Hide completely on small screens
            gap: '20px',
            alignItems: 'center',
          }}
        >
      ...
      <Box
        sx={{
          ...
          top: 0,
          left: showMenu ? 0 : '-100%',
          height: '50vh', // Full height for better UX
          width: { xs: '250px', sm: '300px' }, // Fixed width for consistency
      ...
      >
        ...
        <AdminOnlyLinks>
          <NavLink
            ...
            onClick={() => setShowMenu(false)}
          >
            <Typography sx={textStyle}>Admin</Typography>
          </NavLink>
        </AdminOnlyLinks>
      </Box>
    </Box>
