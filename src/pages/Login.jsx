...
// //   const user = useSelector((state)=> state?.auth?.user)  
//   console.log(`loading is ${isLoading} is logged in is ${isLoggedIn}  and the user is  ${JSON.stringify(user)} `)
//   // const {storedUserDetails} = useSelector((state)=> state?.auth)
// //   console.log(`here we have the updated date like this ${JSON.stringify(storedUserDetails) }`)
...
// //   }
// // }; // ✅ <-- You forgot this closing brace and semicolon!
